  ...
  return (
    ...
    >
      <div className="absolute inset-0 z-0">
        <div
          className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1523741543316-beb7fc7023d8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2340&q=80')] bg-cover bg-center opacity-30"
        ></div>
      ...
      <div className="container mx-auto max-w-6xl z-10 text-center">
        <div className="animate__animated animate__fadeIn">
          ...
          <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-3xl mx-auto font-secondary">
            첨단 기술로 지속 가능한 농업 솔루션을 제공하여<br className="hidden md:block" /> 우리의 식량 시스템을 더 스마트하고 효율적으로 바꿉니다.
          </p>
